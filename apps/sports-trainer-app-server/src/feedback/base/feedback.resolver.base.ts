...
export class FeedbackResolverBase {
  ...
  async createFeedback(
    ...
    return await this.service.createFeedback({
      ...
      data: {
        ...
        trainingSession: args.data.trainingSession
          ? {
              connect: args.data.trainingSession,
            }
          : undefined,
      },
    });
  ...
  @graphql.ResolveField(() => TrainingSession, {
    nullable: true,
  ...
  async getTrainingSession(
    ...
    const result = await this.service.getTrainingSession(parent.id);
