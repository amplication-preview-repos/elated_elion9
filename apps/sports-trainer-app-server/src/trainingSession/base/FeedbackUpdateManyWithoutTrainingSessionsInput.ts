...
@InputType()
class FeedbackUpdateManyWithoutTrainingSessionsInput {
...
export { FeedbackUpdateManyWithoutTrainingSessionsInput as FeedbackUpdateManyWithoutTrainingSessionsInput };
